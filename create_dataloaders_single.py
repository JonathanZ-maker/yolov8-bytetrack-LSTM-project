...
def create_dataloaders_single(window_size, folder_path=None, batch_size=16):
    """
    ...
    for file_name, df in data.items():
        ...
        # ✅ Split into training and testing (80% train, 20% test or at least 1 window size)
        split_idx = min(int(0.8 * len(trajectory_data)), len(trajectory_data) - window_size -1)
        if split_idx <= 0:

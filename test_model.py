...
folder_path = "cam_test/mot-02_test"  # Update this with your actual dataset path
...
BEST_WINDOW_SIZE = 4  # Update based on best result
BEST_HIDDEN_SIZE = 256  # Update based on best result
...
model_filename = "best_mot02_model.pth"  # Model file name
